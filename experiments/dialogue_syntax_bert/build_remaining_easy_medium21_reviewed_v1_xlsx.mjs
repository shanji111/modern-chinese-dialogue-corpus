...
const baseDir =
  "D:\\现代汉语对话语料库-BERT实验\\experiments\\dialogue_syntax_bert\\artifacts\\formal_300_v1\\diagraph_gold_50\\remaining_easy_medium21\\reviewed_v1";

const jobs = [
  {
    csvPath: path.join(baseDir, "remaining_easy_medium21_column_reviewed_v1.csv"),
    xlsxPath: path.join(baseDir, "remaining_easy_medium21_column_reviewed_v1.xlsx"),
  ...
  {
    csvPath: path.join(baseDir, "remaining_easy_medium21_review_decisions.csv"),
    xlsxPath: path.join(baseDir, "remaining_easy_medium21_review_decisions.xlsx"),
    sheetName: "Decisions",
    wideHeaders: new Set([
      "reviewer_note",
    ]),
